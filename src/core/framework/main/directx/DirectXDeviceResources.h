//
// DirectXDeviceResources.h - A wrapper for the Direct3D 11 device and swapchain
//
...
namespace DX
{
    ...
    public:
        ...
        DirectXDeviceResources(DXGI_FORMAT backBufferFormat = DXGI_FORMAT_B8G8R8A8_UNORM,
