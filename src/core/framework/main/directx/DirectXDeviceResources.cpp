...
void DirectXDeviceResources::CreateDeviceResources() 
{
...
void DirectXDeviceResources::SetWindow(HWND window, int width, int height)
{
    m_window = window;
...
bool DirectXDeviceResources::WindowSizeChanged(int width, int height)
{
    RECT newRc;
...
void DirectXDeviceResources::HandleDeviceLost()
{
	if (m_deviceNotify)
	{
...
void DirectXDeviceResources::Present() 
{
	HRESULT hr;
	if (m_options & c_AllowTearing)
	{
...
void DirectXDeviceResources::CreateFactory()
{
...
void DirectXDeviceResources::UpdateColorSpace()
{
