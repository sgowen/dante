...
{
    renderText("'A' to activate Steam", CAM_WIDTH / 2, CAM_HEIGHT - 1, Color::WHITE, FONT_ALIGN_CENTERED);
    renderText("'S' to start local server", CAM_WIDTH / 2, CAM_HEIGHT - 2, Color::WHITE, FONT_ALIGN_CENTERED);
    renderText("'J' to join server by IP", CAM_WIDTH / 2, CAM_HEIGHT - 3, Color::WHITE, FONT_ALIGN_CENTERED);
    renderText("'ESC' to exit game", CAM_WIDTH / 2, CAM_HEIGHT - 8, Color::WHITE, FONT_ALIGN_CENTERED);
}

void TitleRenderer::renderMainMenuSteamOnText()
{
    renderText("'D' to deactivate Steam", CAM_WIDTH / 2, CAM_HEIGHT - 1, Color::WHITE, FONT_ALIGN_CENTERED);
    renderText("'S' to start steam server", CAM_WIDTH / 2, CAM_HEIGHT - 2, Color::WHITE, FONT_ALIGN_CENTERED);
    renderText("'L' to refresh list of LAN servers", CAM_WIDTH / 2, CAM_HEIGHT - 3, Color::WHITE, FONT_ALIGN_CENTERED);
    renderText("'I' to refresh list of Internet servers", CAM_WIDTH / 2, CAM_HEIGHT - 4, Color::WHITE, FONT_ALIGN_CENTERED);
    ...
    for (NGSteamGameServer gameServer : gameServers)
    {
        ...
        renderText(StringUtil::format("'%i' %s", serverNumber, gameServer.getDisplayString()).c_str(), CAM_WIDTH / 2, CAM_HEIGHT - 5.5f - (index * 0.5f), Color::WHITE, FONT_ALIGN_CENTERED);
