...
#define MENU_STATE_SERVER_TOGGLE_ATMOSPHERE 17
#define MENU_STATE_SERVER_TOGGLE_SERVER_DISPLAY 18
#define MENU_STATE_CLIENT_MAIN_TOGGLE_MUSIC 19
#define MENU_STATE_CLIENT_MAIN_TOGGLE_SOUND 20
