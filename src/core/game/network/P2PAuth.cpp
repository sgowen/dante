...
CP2PAuthPlayer::CP2PAuthPlayer(CNetworkTransport *pNetworkTransport) :
...
void CP2PAuthedGame::InternalInitPlayer(int iSlot, CSteamID steamID, bool bStartAuthProcess)
{
	...
	LOG(rgch);
	m_rgpP2PAuthPlayer[iSlot] = new CP2PAuthPlayer(m_pNetworkTransport);
